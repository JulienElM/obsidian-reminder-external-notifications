...
`reminderInfo` is an additional object with more information, in case you want to send the data through a middleware first (see [Advanced notifications with selfhosted ntfy and middleware](#advanced-notifications-with-selfhosted-ntfy-and-middleware) ) 
## Additional headers
